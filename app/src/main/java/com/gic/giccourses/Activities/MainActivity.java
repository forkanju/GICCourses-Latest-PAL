...
import com.gic.giccourses.Models.DifficultyLevel;
import com.gic.giccourses.Models.Language;
import com.gic.giccourses.Models.Price;
import com.gic.giccourses.Models.Rating;
...
//    }
    ...
    private void filterCourse() {
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl(Api.BASE_URL).addConverterFactory(GsonConverterFactory.create()).build();
        Api api = retrofit.create(Api.class);
        Call<List<CourseSchema>> call = api.getFilteredCourses(selectedCategory, selectedPrice, "all", "all", "all", searchedString);
